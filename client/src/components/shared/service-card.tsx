...
export default function ServiceCard({ icon: Icon, title, description, features, image, href }: ServiceCardProps) {
  return (
    <Link href={href}>
      <Card className="service-card bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
